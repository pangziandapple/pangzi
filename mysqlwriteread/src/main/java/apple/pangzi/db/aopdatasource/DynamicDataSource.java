...
public class DynamicDataSource extends AbstractRoutingDataSource {
    ...
    /**
     * 初始化数据源，数据源存放到AbstractRoutingDataSource   targetDataSources变量上
     */
    @Override
    ...
    /**
     * 根据注解获取读写数据源标识，实现AbstractRoutingDataSource  determineCurrentLookupKey的方法，
     * 此方法在AbstractRoutingDataSource.determineTargetDataSource()中有调用获取数据源的键值
     */
    @Override
